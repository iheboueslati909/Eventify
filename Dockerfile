...
COPY ["eventify.Application/eventify.Application.csproj", "eventify.Application/"]
COPY ["eventify.Domain/eventify.Domain.csproj", "eventify.Domain/"]
COPY ["SharedKernel/eventify.SharedKernel.csproj", "SharedKernel/"]
COPY ["eventify.Infrastructure/eventify.Infrastructure.csproj", "eventify.Infrastructure/"]
